...
class OpenSSLTests: XCTestCase {
	...
	// Use Scripts/ssl/sign_pss.sh example.json to generate the pss signature (use generate/client.crt, generate/chain.pem)
