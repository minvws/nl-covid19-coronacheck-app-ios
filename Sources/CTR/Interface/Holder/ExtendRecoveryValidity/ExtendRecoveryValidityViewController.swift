...
class ExtendRecoveryValidityViewController: BaseViewController {

	private let viewModel: ExtendRecoveryValidityViewModel
	private let sceneView = ExtendRecoveryValidityView()

	/// Initializer
	/// - Parameter viewModel: view model
	init(viewModel: ExtendRecoveryValidityViewModel) {
