...
final class Services {
	...
	private static var databaseManagingType: DatabaseManaging.Type = DatabaseManager.self
	...
	static private(set) var databaseManager: DatabaseManaging = databaseManagingType.init()
