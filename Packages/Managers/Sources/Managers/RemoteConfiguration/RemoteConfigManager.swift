...
public protocol RemoteConfigManaging: AnyObject {
...
public class RemoteConfigManager: RemoteConfigManaging {
	...
	public private(set) var storedConfiguration: RemoteConfiguration {
		get { secureUserSettings.storedConfiguration }
		set { secureUserSettings.storedConfiguration = newValue }
	}

	public let observatoryForUpdates: Observatory<RemoteConfigManager.ConfigNotification>
	private let notifyUpdateObservers: (RemoteConfigManager.ConfigNotification) -> Void
	
	public let observatoryForReloads: Observatory<Result<RemoteConfigManager.ConfigNotification, ServerError>>
