...
public protocol VerificationPolicyEnableable: AnyObject {
	var observatory: Observatory<[VerificationPolicy]> { get }
	
	func wipePersistedData()
}

public final class VerificationPolicyEnabler: VerificationPolicyEnableable {
	...
	public func enable(verificationPolicies: [String]) {
