...
public protocol ClockDeviationManaging: AnyObject {
...
public final class ClockDeviationManager: ClockDeviationManaging {
	...
	public static func currentSystemUptime() -> __darwin_time_t? {
